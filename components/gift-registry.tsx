        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto text-pretty leading-relaxed px-4">
             ...
             Si deseas tener un detalle con nosotros, puedes hacerlo desde nuestra mesa de regalos, por medio de certificados ya que gracias a Dios, 
          ...
          <Card className="p-6 md:p-8 bg-accent/10 border-accent/20 mb-6">
